            ...
            <div class="content col-12 col-md-9">
                    ...
                    <div id="but">
                        ...
                        <div class="mt-5">
                            <table>
                                ...
                                <?php
                                $result = $conn->prepare("SELECT Event_detail_ID, Event_detail_title, Event_detail_sub, Event_title, Img_url, Event_detail_img FROM event JOIN event_detail ON event.Event_ID = event_detail.Event_ID WHERE event_detail.isDelete = 'N'");
                                $result->execute();
                                ...
                                while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
                                    ...
                                    // echo "<td><img src='../../BackEnd/" . htmlspecialchars($row['Img_url'] ?? '') . "' alt='Event Image' width='100' height='100'></td>";
                ...
                <div id="astronaut_details" class="hidden">
                    ...
                    <div id="add_astronaut" class="p-4 bg-light rounded shadow-sm">
                        ...
                        <form action="../../BackEnd/admin/astronaut_process.php" method="POST" enctype="multipart/form-data"
                            class="d-flex flex-column align-items-center">
