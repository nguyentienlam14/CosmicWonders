                ...
                <div id="home" class="p-4 bg-light rounded shadow-sm">
                    <div class="container">
                        ...
                        <div class="text-center mb-5">
                            <img src="../assets/img/body/rocket-launch-at-sunset" class="img-fluid rounded" alt="Explore the Universe">
                        </div>
                    </div>
                </div>
                        ...
                        <div class="mt-5">
                            <table>
                                ...
                                while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
                                    ...
                                    echo "<td><img src='../../BackEnd/uploads/" . htmlspecialchars($row['Event_detail_img'] ?? '') . "' alt='Event Image' width='100' height='100'></td>";
                                    echo "<td>
