    ...
    public function createTables()
    {
        $sql = [
            ...
            "CREATE TABLE IF NOT EXISTS Event_detail (
                ...
                Event_detail_title TEXT NOT NULL,
                Event_detail_sub_text TEXT NOT NULL,
                Event_detail_img TEXT,
                Event_ID INT,
                isDelete CHAR(1) NOT NULL DEFAULT 'N',
                created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
                updated_at DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
            ...
            "CREATE TABLE IF NOT EXISTS Celestial_detail (
                ...
                Celestial_detail_title TEXT NOT NULL,
                Celestial_detail_sub TEXT NOT NULL,
                Other_details TEXT,
                Celestial_discovery_date TEXT,
                Celestial_size TEXT,
                Celestial_ozone TEXT,
                Celestial_distance_s_e TEXT,
                Celestial_ID INT,
                Celestial_detail_img TEXT,
                isDelete CHAR(1) NOT NULL DEFAULT 'N',
                created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
                updated_at DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
