...
try {
    ...
    $events = [
        ...
        [
            ...
            'Event_detail_sub_text' => 'The origin, evolution, and nature of the universe have fascinated and confounded humankind
                        for
                        ...
                        is
                        the history of the universe according to cosmologists’ current theories.',
            'Event_detail_img' => '',
            'Event_ID' => '2',
            'isDelete' => 'N',
            'created_at' => date('Y-m-d H:i:s'),
        ...
        [
            ...
            'Event_detail_sub_text' => 'Around 13.8 billion years ago, the universe expanded faster than the speed of light for a
                        ...
                        which
                        eventually helped form the universe’s large-scale structures.',
            'Event_detail_img' => '',
            'Event_ID' => '2',
            'isDelete' => 'N',
            'created_at' => date('Y-m-d H:i:s'),
        ...
        [
            ...
            'Event_detail_sub_text' => 'When cosmic inflation stopped, the energy driving it transferred to matter
                        and light –
                        ...
                        a vast number
                        of electrons created a sort of fog that scattered light.',
            'Event_detail_img' => '',
            'Event_ID' => '2',
            'isDelete' => 'N',
            'created_at' => date('Y-m-d H:i:s'),
        ...
        [
            ...
            'Event_detail_sub_text' => 'Around 380,000 years after the big bang, the universe had cooled enough that
                        atomic
        ...
        [
            ...
            'Event_detail_sub_text' => 'After the cosmic microwave background, the universe again became opaque at shorter
                        wavelengths due
                        ...
                        of hydrogen
                        atoms, helium, and trace amounts of heavier elements.',
            'Event_detail_img' => '',
            'Event_ID' => '2',
            'isDelete' => 'N',
            'created_at' => date('Y-m-d H:i:s'),
